...
if (($_SESSION['rol'] ?? '') !== 'empresa') {
    header("Location: index.php?msg=solo_empresa");
    exit();
}
?>
<!DOCTYPE html>
            ...
            <form method="post" class="fade-in">
                <div class="form-group">
                    ...
                    <input type="text" name="titulo" id="titulo"
                        placeholder="Ej: Práctica Profesional en Desarrollo Web" required>
                </div>

                <div class="form-group">
                    <label for="descripcion"><i class="fas fa-align-left"></i> Descripción</label>
                    <textarea name="descripcion" id="descripcion"
                        placeholder="Describe los requisitos, responsabilidades y beneficios de la oferta..."
                        rows="5"></textarea>
                </div>
                ...
                <?php if (isset($_SESSION['id_usuario'])): ?>
                    <input type="hidden" name="id_usuario" id="id_usuario"
                        value="<?php echo (int) $_SESSION['id_usuario']; ?>">
                    <div class="form-group">
                        <label><i class="fas fa-user"></i> ID Usuario Empresa</label>
                        <input type="text" value="#<?php echo (int) $_SESSION['id_usuario']; ?>" readonly>
                        <small style="color: var(--text-light); font-size: 0.8rem;">
                            El sistema usará automáticamente tu ID de empresa de la sesión.
                        </small>
                    </div>
                <?php endif; ?>
